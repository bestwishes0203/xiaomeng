<template>
  <div class="LoginView">
    <el-row>
      <el-col :span="6">
        <div class="banner">
          <!--          <img src="https://mp-f72177b8-1fab-46ad-a38c-c6556eac7a3b.cdn.bspapp.com/cloudstorage/7038a077-a564-4091-980d-498ff019f255.jpg" @click="router.push({name:'home'})">-->
      ...
      <el-col :span="18">
        ...
        <el-card shadow="never" class="nav">
          <el-card class="main_view">
            <el-menu mode="horizontal" default-active="/login" class="login_menu" router>
