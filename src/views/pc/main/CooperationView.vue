  ...
  <div class="ServeView">
    <div>
      <img style="width: 100%; height: 100vh"
           src="@/assets/cooperation.jpg"/>
    </div>
  </div>

  <div class="transform_view"></div>

  <div class="absolute_view">
    <div class="gradle_color"
         style="width: 80%;height: 80vh;transform: translateY(10vh);color: white;margin: 0 auto;border-radius: 40px;">
      <div style="width: 100%;height: 100%;display: flex;flex-direction: row;">
        <div
            style="width: 100%;height: 100%;flex: 1;font-size: 20px;color: white;display: flex;align-items: center;justify-content: center;">
          <div style="text-align: left;transform: translateY(-40px);">
            <h1>加入小梦</h1>
            <p>推动和发展有限资源的可持续化利用</p>
            <p>为环保事业做出一份贡献!</p>
            <p>欢迎联系我们!</p>
            <p>400-198-0237</p>
          </div>
        ...
        <div
            style="width: 100%;height: 100%;flex: 1;display: flex;justify-content: center;align-items: center;">
          <img class="turnBig" style="width: 50%;height: 50%;" src="@/assets/lighting.png"/>
        </div>
      </div>
    </div>
  </div>
